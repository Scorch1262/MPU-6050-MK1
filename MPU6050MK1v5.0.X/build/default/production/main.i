...
# 186 "main.c"
    ...
    uint16_t gY_Data;
    uint16_t gZ_Data;
    I2C_Write1ByteRegister(0x69, 0x19, 0x07);
    I2C_Write1ByteRegister(0x69, 0x6B, 0x01);
    I2C_Write1ByteRegister(0x69, 0x1A, 0x00);
    I2C_Write1ByteRegister(0x69, 0x1B, 0x18);
    I2C_Write1ByteRegister(0x69, 0x38, 0x01);
    ...
    while (1){
        ...
        X_Data = I2C_Read2ByteRegister(0x69,0x3B);
        Y_Data = I2C_Read2ByteRegister(0x69,0x3D);
        Z_Data = I2C_Read2ByteRegister(0x69,0x3F);
        gX_Data = I2C_Read2ByteRegister(0x69,0x43);
        gY_Data = I2C_Read2ByteRegister(0x69,0x45);
        gZ_Data = I2C_Read2ByteRegister(0x69,0x47);
        printf("X= %d\r\n",X_Data);
        printf("Y= %d\r\n",Y_Data);
        printf("Z= %d\r\n",Z_Data);
        printf("gX= %d\r\n",gX_Data);
